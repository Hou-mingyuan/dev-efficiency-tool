<template>
  <div class="page-container generator-page">
    <div class="generator-page__header">
      <a-typography-title :level="4">{{ t("gen.requirements.title") }}</a-typography-title>
      <p class="generator-page__desc">{{ t("gen.requirements.description") }}</p>
    </div>
...
const historyRows = computed(() => historyList.value.filter((r) => r.docType === "requirements"));
